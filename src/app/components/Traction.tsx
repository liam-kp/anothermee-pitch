...
const metrics: Metric[] = [
  {
    ...
    value: ["WhatsApp", "Telegram", "Slack", "Platforms", "API"],
  },
  {
    title: "Status",
        ...
        <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-3">
          {metrics.map((metric, i) => (
            <motion.div
              ...
              className={`flex flex-col items-center justify-center rounded-2xl border px-10 py-14 text-center backdrop-blur-sm transition-all duration-300 ease-out hover:-translate-y-0.5 md:px-12 md:py-20 ${
                metric.highlight
