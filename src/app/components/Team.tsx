...
const team: Member[] = [
  {
    name: "Asi Meskin",
    role: "CEO",
    hook: "Distribution & Monetization Strategy",
    description:
      "Drives partnerships, distribution, and revenue growth at scale.",
  ...
  },
  {
    ...
    hook: "Conversation Intelligence & AI Systems",
    description:
      "Builds adaptive AI that drives high-conversion conversations in real time.",
  ...
  },
  {
    name: "Nir Dunia",
    role: "CTO",
    hook: "Infrastructure & Scalable Deployment",
    description:
      "Architects real-time, multi-channel systems built to scale reliably.",
  ...
  },
  {
    name: "Sefi Sasson",
    role: "CPO",
    hook: "Product & Monetization Flow Design",
    description: "Designs end-to-end flows that turn interaction into revenue.",
  ...
  },
  {
    name: "Liran Miller",
    role: "COO",
    hook: "Revenue Operations (Live Systems)",
    description: "Turns AI systems into live revenue engines in production.",
